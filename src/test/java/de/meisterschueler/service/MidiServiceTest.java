...
public class MidiServiceTest {
	...
	@Test
	public void midiCorrectionTest() {
		NoteOn noteOn = new NoteOn(0, 0, 60, 0);
		MidiEvent result = midiService.correctMidi(noteOn);
		assertEquals( NoteOff.class, result.getClass() );
	}
